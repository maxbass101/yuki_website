(() => {
    ...
    function initSliders() {
        if (document.querySelector(".video-slider__slider")) new core(".video-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".video-slider__arrow.swiper-button-prev",
                nextEl: ".video-slider__arrow.swiper-button-next"
            },
            breakpoints: {
                299: {
                    slidesPerView: 1,
    ...
    function windowLoad() {
        ...
        function christmasAnimation(finalPos) {
            ...
            shadows.style.cssText = `\n         transform:\n            translate(0, ${shadowsAnim.translate}%)\n            scale(${shadowsAnim.scale});\n      `;
            layers.forEach(((layer, index) => {
                const layerAnim = {
                    translate: 30 * (layers.length - index) / 100 * finalPos,
                    scale: 1 + 2 / 100 * finalPos
                };
                layer.style.cssText = `\n            transform:\n            translate(0, ${layerAnim.translate}%)\n            scale(${layerAnim.scale});\n         `;
            }));
            playerItems.forEach(((playerItem, index) => {
                const playerAnim = {
                    left: (100 + 10 * index) / 100 * finalPos
                };
                playerItem.style.left = `${playerAnim.left}%`;
            }));
        }
    }
    window["FLS"] = true;
